...
(function (root, factory) {
    ...
    var STRINGS = {
        ...
        AttachmentList_Desc: 'The notes and attachments on a record, with download.',
        Records_DataSet_Name: 'Notes',
        fileNameColumn_Name: 'File name',
        fileNameColumn_Desc: 'The column holding the file name — filename on the Note table.',
        fileSizeColumn_Name: 'File size',
        fileSizeColumn_Desc: 'The column holding the size in bytes — filesize. Without it, no size is shown.',
        mimeTypeColumn_Name: 'File type',
        mimeTypeColumn_Desc: 'The column holding the MIME type — mimetype. Without it, downloads are saved as a generic file.',
        isDocumentColumn_Name: 'Is a file',
        isDocumentColumn_Desc: 'The column that tells a file from a text note — isdocument. Without it, a row with a file name is treated as a file.',
        subjectColumn_Name: 'Title',
        subjectColumn_Desc: 'The column holding the title — subject. Without it, the file name is the title.',
        createdOnColumn_Name: 'Created on',
        createdOnColumn_Desc: 'The column holding the creation date — createdon. Without it, no date is shown.',
        bodyColumn_Name: 'Body column',
        bodyColumn_Desc: 'The logical name of the column holding the file itself. Fetched only when a file is downloaded.',
        hideTextNotes_Name: 'Hide text notes',
        hideTextNotes_Desc: 'Show only rows that carry a file.',
        maxDownloadSizeMb_Name: 'Maximum download (MB)',
        maxDownloadSizeMb_Desc: 'Files larger than this are refused before they are fetched.',
        pageSize_Name: 'Page size',
        pageSize_Desc: 'How many rows to request per page. The platform may clamp large values.',
        downloadedRecordId_Name: 'Downloaded note ID',
        downloadedRecordId_Desc: 'The ID of the row whose download was last requested. Use this to download the file yourself in a canvas app.',
        hideUpload_Name: 'Hide Add files',
        hideUpload_Desc: 'Remove the Add files button and ignore dropped files. Attaching is available anyway only on an editable form with a parent record.',
        accept_Name: 'Allowed file types',
        accept_Desc: 'Comma-separated extensions or MIME types, like .pdf,.docx,image/*. Empty allows any file.',
        maxUploadSizeMb_Name: 'Maximum upload (MB)',
        maxUploadSizeMb_Desc: 'Files larger than this are refused before they are read. Unset, the organisation’s own attachment limit is used.',
        uploadedRecordId_Name: 'Attached note ID',
        uploadedRecordId_Desc: 'The ID of the note most recently created by this control.',
        AttachmentList_Loading: 'Loading notes…',
        AttachmentList_Empty: 'No notes on this record.',
        AttachmentList_NoFiles: 'No attachments on this record.',
        AttachmentList_DeprecatedColumn: 'This control cannot use the “File Name(deprecated)” column: Dataverse refuses to read it, and mapping it stops the whole list loading. Clear the File name mapping on this subgrid — the control finds the real file name on its own.',
        AttachmentList_Error: 'These notes could not be loaded.',
        AttachmentList_NoFileNameColumn: 'Map a column to File name to list the attachments.',
        AttachmentList_ListLabel: 'Attachments',
        AttachmentList_UntitledFile: 'Untitled file',
        AttachmentList_UntitledNote: 'Untitled note',
        ...
        AttachmentList_TooLarge: 'This file is larger than the {0} MB limit set for this control.',
        AttachmentList_DownloadUnavailable: 'Downloading needs a model-driven app.',
        AttachmentList_AddFiles: 'Add files',
        AttachmentList_DropHint: 'Drop files here to attach them',
        ...
        AttachmentList_UploadUnavailable: 'Attaching files needs an editable model-driven form.',
        AttachmentList_Previous: 'Previous page',
        AttachmentList_Next: 'Next page',
        AttachmentList_PageStatus: 'Page {0}',
        AttachmentList_RangeStatus: '{0}–{1} of {2}',
    };
